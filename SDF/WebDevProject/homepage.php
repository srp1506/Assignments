...
?>
        ...
        <div id="screen">
        <iframe id="scrin"  src="http://localhost/WebDevProject/discription.php">  
...
<script>
    ...
    function changescreen(...args){
        ...
        document.getElementById('scrin').src="http://localhost/WebDevProject/discription.php?name="+args;
        
    }
    function dele(...args){
        document.getElementById('scrin').src="http://localhost/WebDevProject/delet.php?projectname="+args;  
